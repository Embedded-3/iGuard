...
#define PWM_PERIOD          80000                                   /* PWM period for the TOM                       */
//#define FADE_STEP           PWM_PERIOD / 30                        /* PWM duty cycle for the TOM                   */
...
FanSpeed_t g_fanSpeed = FAN_SPEED_LOW;
...
void initGtmTomPwm(void)
{
    ...
    g_tomConfig.tom = FAN.tom;                                      /* Select the TOM depending on the LED          */
    g_tomConfig.tomChannel = FAN.channel;                           /* Select the channel depending on the LED      */
    g_tomConfig.period = PWM_PERIOD;                                /* Set the timer period                         */
    g_tomConfig.pin.outputPin = &FAN;                               /* Set the LED port pin as output               */
...
void controlFan(void)
{
    uint32 FADE_STEP = PWM_PERIOD/50;
